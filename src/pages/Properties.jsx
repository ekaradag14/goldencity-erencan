...
function Properties() {
  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-secondary-900 transition-colors">
        ...
        <div className="container py-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <button
                className={`p-2 rounded-md transition-colors ${showFilters ? 'bg-primary-100 dark:bg-primary-900/50 text-primary-600 dark:text-primary-400' : 'hover:bg-secondary-100 dark:hover:bg-secondary-700 dark:text-secondary-300'}`}
      ...
      {/* Filters */}
      {showFilters && (
        <div className="bg-white dark:bg-secondary-800 shadow-md dark:shadow-secondary-900/50 border-t dark:border-secondary-700 transition-colors">
          <div className="container py-6">
      ...
      <div className="container py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {sortedProperties.map((property, index) => (
            <motion.div
              key={property.id}
              className="bg-white dark:bg-secondary-800 rounded-lg shadow-md dark:shadow-secondary-900/50 overflow-hidden transition-colors"
            ...
            >
              <Link to={`/properties/${property.id}`}>
                ...
                <div className="p-6">
                  ...
                  {/* Token Details */}
                  <div className="bg-secondary-50 dark:bg-secondary-700 rounded-lg p-3 mb-4 transition-colors">
                    <div className="flex justify-between text-sm">
