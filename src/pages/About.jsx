...
function About() {
  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-secondary-900 transition-colors">
      {/* Hero Section */}
      <section className="relative bg-primary-600 dark:bg-secondary-950 text-white py-24 transition-colors">
        <div className="container">
          ...
          >
            ...
            <p className="text-xl text-primary-100 dark:text-secondary-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="bg-white dark:bg-secondary-800 rounded-lg p-6 text-center shadow-md dark:shadow-secondary-900/50 transition-colors"
              >
      ...
      {/* Mission Section */}
      <section className="py-16 bg-white dark:bg-secondary-800 transition-colors">
        <div className="container">
