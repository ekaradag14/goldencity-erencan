...
function PropertyDetail() {
  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-secondary-900 transition-colors">
      {/* Navigation */}
      <div className="bg-white dark:bg-secondary-800 shadow dark:shadow-secondary-900/50 transition-colors">
        <div className="container py-4">
          <div className="flex items-center space-x-2 text-sm">
            <Link to="/" className="text-secondary-600 dark:text-secondary-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">Home</Link>
            <span className="text-secondary-400">/</span>
            <Link to="/properties" className="text-secondary-600 dark:text-secondary-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">Properties</Link>
            <span className="text-secondary-400">/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <motion.div
              ...
              className="bg-white dark:bg-secondary-800 rounded-lg shadow-md dark:shadow-secondary-900/50 p-6 transition-colors"
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="flex items-center space-x-2 dark:text-secondary-200">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-6">
                {property.features.map((feature, index) => (
                  <div key={index} className="flex items-center space-x-2 dark:text-secondary-200">
              ...
              <div className="bg-secondary-50 dark:bg-secondary-700 rounded-lg p-6 mb-6 transition-colors">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-secondary-50 dark:bg-secondary-700 rounded-lg p-6 transition-colors">
          ...
          >
            ...
            <div className="bg-white dark:bg-secondary-800 rounded-lg shadow-md dark:shadow-secondary-900/50 p-6 transition-colors">
              ...
              <div className="space-y-2">
                <p className="text-sm dark:text-secondary-200">
